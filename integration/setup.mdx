...
Visit your [KoruAI Dashboard](https://koruai.com/dashboard) to verify that requests are being recorded.
...
const getKoruAIConfig = () => {
  ...
  if (!config.apiKey || !config.appId) {
    throw new Error('KoruAI configuration missing. Check your environment variables.');
  }
